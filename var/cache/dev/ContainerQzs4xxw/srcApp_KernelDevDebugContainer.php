...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\RabbitDataController' => 'getRabbitDataControllerService',
            'App\\Service\\DataBaseService' => 'getDataBaseServiceService',
    ...
    protected function getCollectDataControllerService()
    {
        ...
        return $this->services['App\\Controller\\CollectDataController'] = new \App\Controller\CollectDataController($this);
    }
    ...
    protected function getDataBaseControllerService()
    {
        ...
        $this->services['App\\Controller\\DataBaseController'] = $instance = new \App\Controller\DataBaseController($this);

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\DataBaseController', $this));
    ...
    protected function getFilterDataControllerService()
    {
        ...
        return $this->services['App\\Controller\\FilterDataController'] = new \App\Controller\FilterDataController($this);
    }

    /**
     * Gets the public 'App\Controller\RabbitDataController' shared autowired service.
     *
     * @return \App\Controller\RabbitDataController
     */
    protected function getRabbitDataControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\RabbitDataController.php';

        $this->services['App\\Controller\\RabbitDataController'] = $instance = new \App\Controller\RabbitDataController($this);

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\RabbitDataController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Service\DataBaseService' shared autowired service.
     *
    ...
    protected function getDataBaseServiceService()
    {
        ...
        return $this->services['App\\Service\\DataBaseService'] = new \App\Service\DataBaseService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
