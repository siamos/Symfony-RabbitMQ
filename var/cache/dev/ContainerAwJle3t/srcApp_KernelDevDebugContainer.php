...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getRabbitDataServiceService()
    {
        ...
        return $this->services['App\\Consumer\\RabbitDataService'] = new \App\Consumer\RabbitDataService();
    }
    ...
    protected function getDataBaseControllerService()
    {
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'router' => '?',
            'session' => '?',
        ]))->withContext('App\\Controller\\DataBaseController', $this));
