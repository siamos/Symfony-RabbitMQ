...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\CollectDataController' => 'getCollectDataControllerService',
            'App\\Controller\\DataBaseController' => 'getDataBaseControllerService',
            'App\\Controller\\FilterDataController' => 'getFilterDataControllerService',
            ...
            'old_sound_rabbit_mq.connection.another' => 'getOldSoundRabbitMq_Connection_AnotherService',
            'old_sound_rabbit_mq.connection.default' => 'getOldSoundRabbitMq_Connection_DefaultService',
            'old_sound_rabbit_mq.data_filtering_consumer' => 'getOldSoundRabbitMq_DataFilteringConsumerService',
            'old_sound_rabbit_mq.data_filtering_producer' => 'getOldSoundRabbitMq_DataFilteringProducerService',
    ...
    /**
     * Gets the public 'App\Controller\CollectDataController' shared autowired service.
     *
     * @return \App\Controller\CollectDataController
     */
    protected function getCollectDataControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\CollectDataController.php';

        return $this->services['App\\Controller\\CollectDataController'] = new \App\Controller\CollectDataController();
    }
     ...
     */
    protected function getDataBaseControllerService()
    {
        ...
        return $this->services['App\\Controller\\DataBaseController'] = new \App\Controller\DataBaseController();
    }

    /**
     * Gets the public 'App\Controller\FilterDataController' shared autowired service.
     *
     * @return \App\Controller\FilterDataController
     */
    protected function getFilterDataControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\FilterDataController.php';

        return $this->services['App\\Controller\\FilterDataController'] = new \App\Controller\FilterDataController();
    }
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('38hX2e0yl2', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CFJRIcdfzi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\EnergyEntitiesRepository' => ['privates', 'App\\Repository\\EnergyEntitiesRepository', 'getEnergyEntitiesRepositoryService', false],
        ], [
            'App\\Repository\\EnergyEntitiesRepository' => '?',
        ])));
    ...
    /**
     * Gets the public 'old_sound_rabbit_mq.connection.another' shared service.
     *
     * @return \PhpAmqpLib\Connection\AMQPConnection
     */
    protected function getOldSoundRabbitMq_Connection_AnotherService()
    {
        ...
        return $this->services['old_sound_rabbit_mq.connection.another'] = (new \OldSound\RabbitMqBundle\RabbitMq\AMQPConnectionFactory('PhpAmqpLib\\Connection\\AMQPConnection', ['url' => 'amqp://cand_oziq:ByVOkcn91YL1SMuv@candidatemq.n2g-dev.net:1883/vhost?lazy=1&connection_timeout=6', 'host' => 'localhost', 'port' => 5672, 'user' => 'guest', 'password' => 'guest', 'vhost' => '/', 'lazy' => false, 'connection_timeout' => 3, 'read_write_timeout' => 3, 'use_socket' => false, 'ssl_context' => [], 'keepalive' => false, 'heartbeat' => 0]))->createConnection();
    }
    ...
    protected function getOldSoundRabbitMq_Connection_DefaultService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\php-amqplib\\php-amqplib\\PhpAmqpLib\\Channel\\AbstractChannel.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\php-amqplib\\php-amqplib\\PhpAmqpLib\\Connection\\AbstractConnection.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\php-amqplib\\php-amqplib\\PhpAmqpLib\\Connection\\AMQPSocketConnection.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\php-amqplib\\rabbitmq-bundle\\RabbitMq\\AMQPConnectionFactory.php';

        return $this->services['old_sound_rabbit_mq.connection.default'] = (new \OldSound\RabbitMqBundle\RabbitMq\AMQPConnectionFactory('PhpAmqpLib\\Connection\\AMQPSocketConnection', ['url' => $this->getEnv('RABBITMQ_URL'), 'host' => 'candidatemq.n2g-dev.net', 'port' => 1883, 'user' => 'cand_oziq', 'password' => 'ByVOkcn91YL1SMuv', 'vhost' => '/', 'lazy' => false, 'connection_timeout' => 3, 'read_write_timeout' => 3, 'keepalive' => false, 'heartbeat' => 3, 'use_socket' => true, 'ssl_context' => []]))->createConnection();
    }

    /**
     * Gets the public 'old_sound_rabbit_mq.data_filtering_consumer' shared service.
     *
     * @return \OldSound\RabbitMqBundle\RabbitMq\Consumer
     */
    protected function getOldSoundRabbitMq_DataFilteringConsumerService()
    {
        ...
        $this->services['old_sound_rabbit_mq.data_filtering_consumer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Consumer(($this->services['old_sound_rabbit_mq.connection.default'] ?? $this->getOldSoundRabbitMq_Connection_DefaultService()));

        $instance->setExchangeOptions(['name' => 'cand_oziq', 'type' => 'direct', 'passive' => false, 'durable' => true, 'auto_delete' => false, 'internal' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL]);
        $instance->setQueueOptions(['name' => 'cand_oziq_results', 'passive' => false, 'durable' => true, 'exclusive' => false, 'auto_delete' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL, 'routing_keys' => []]);
        $instance->setCallback([0 => new \App\Rabbit\RabbitDataService(), 1 => 'execute']);
    ...
    /**
     * Gets the public 'old_sound_rabbit_mq.data_filtering_producer' shared service.
     *
     * @return \OldSound\RabbitMqBundle\RabbitMq\Producer
     */
    protected function getOldSoundRabbitMq_DataFilteringProducerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\php-amqplib\\rabbitmq-bundle\\RabbitMq\\BaseAmqp.php';
        ...
        $this->services['old_sound_rabbit_mq.data_filtering_producer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Producer(($this->services['old_sound_rabbit_mq.connection.default'] ?? $this->getOldSoundRabbitMq_Connection_DefaultService()));
    ...
    protected function getOldSoundRabbitMq_PartsHolderService()
    {
        ...
        $a = ($this->services['old_sound_rabbit_mq.data_filtering_producer'] ?? $this->getOldSoundRabbitMq_DataFilteringProducerService());
        $b = ($this->services['old_sound_rabbit_mq.data_filtering_consumer'] ?? $this->getOldSoundRabbitMq_DataFilteringConsumerService());
    ...
    /**
     * Gets the private 'App\Repository\EnergyEntitiesRepository' shared autowired service.
     *
     * @return \App\Repository\EnergyEntitiesRepository
     */
    protected function getEnergyEntitiesRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Repository\\EnergyEntitiesRepository.php';

        return $this->privates['App\\Repository\\EnergyEntitiesRepository'] = new \App\Repository\EnergyEntitiesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5ceS7gQiBn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'old_sound_rabbit_mq.base_amqp' => [
                0 => 'old_sound_rabbit_mq.data_filtering_producer',
                1 => 'old_sound_rabbit_mq.data_filtering_consumer',
            ],
            'console.command.ids' => [
